...
const Header = ({ UserName }) => {
    ...
    return (
        <div className='w-full p-2 flex justify-between items-center pt-3 pb-3'>
            <h1 className='text-2xl text-green-900 font-serif '>Treasure-Hunt</h1>
            <div className='flex gap-2'>
                ...
                <select name="" id="" defaultValue={UserName} onChange={handleLogout}>
